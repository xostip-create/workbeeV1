      ...
      <header className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/shops" className="text-sm font-medium hover:text-primary transition-colors">Marketplace</Link>
          </nav>
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in-up">
              ...
              <h2 className="text-5xl md:text-7xl font-extrabold text-foreground leading-[1.1] font-headline">
                Reliable Experts. <br />
                <span className="text-primary">Trusted Stores.</span>
              </h2>
        ...
        <section className="py-24 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: 'Find Pros', icon: <Search />, link: '/workers', color: 'bg-blue-50 text-blue-600', desc: 'Verified local experts' },
                { title: 'Browse Gigs', icon: <Briefcase />, link: '/jobs', color: 'bg-green-50 text-green-600', desc: 'Available opportunities' },
                { title: 'Marketplace', icon: <ShoppingBag />, link: '/shops', color: 'bg-purple-50 text-purple-600', desc: 'Shop local storefronts' },
                { title: 'Hire Now', icon: <PlusCircle />, link: '/post-job', color: 'bg-orange-50 text-orange-600', desc: 'Post a request' },
              ].map((item, idx) => (
